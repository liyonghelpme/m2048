...
function TestScene:ctor()
    ...
    local sp = setSize(setColor(setPos(addChild(self.leftUp, createSprite("round.png")), {84, 960-190}), {242, 177, 121}), {48, 48})
    sp:runAction(repeatForever(sinein(sequence({moveby(0.5, 250, 0), moveby(0.5, -250, 0)}))))
